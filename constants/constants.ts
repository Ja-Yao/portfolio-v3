...
export const testimonials = [
	...
	// },
	{
		...
		major:
			"He was put on the frontend team for Black Cape's Space-Time Intelligence & Reasoning Engine (STIRE), and ended up leading the effort to take the UI from a demo to a production-ready system."
	}
];
