...
export const testimonials = [
  ...
  // },
  {
    ...
    major: "He was put on the frontend team [for one of Black Cape's projects], and ended up leading the effort to take the UI from a demo to a production-ready system."
  }
];
